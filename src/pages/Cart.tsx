...
// Temporary cart data until we implement cart functionality
const cartItems = [
  {
    id: 1,
  ...
  return (
    <div className="bg-finesse-black min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="font-playfair text-4xl font-bold mb-12">
          Shopping Cart
        </h1>
        ...
        {cartItems.length > 0 ? (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              {cartItems.map((item) => (
                <div
                  key={item.id}
                  className="bg-finesse-gray-900 p-6 rounded-sm flex space-x-6"
                >
                  <img
                    src={item.image}
                    alt={item.name}
              ...
              <div className="space-y-4 font-raleway">
                ...
                <div className="border-t border-finesse-gray-800 pt-4">
                  <div className="flex justify-between font-semibold">
                    <span>Total</span>
                    <span className="text-finesse-gold">
          ...
          <div className="text-center py-12">
            <p className="font-raleway text-xl text-finesse-gray-400 mb-6">
              Your cart is empty
            </p>
            <Link
              to="/collections"
